...
def main():
    ...
    for number in [1000*i for i in range(1,8)]:
        ...
        Distance.append(dis_sum_4)
        Time.append(time_cost_4)
        with open("result/chain_result_"+str(number)+".pkl","wb") as fp:
            pickle.dump(match_result_4,fp)
        with open("result/chain_distance.pkl","wb") as fp:
